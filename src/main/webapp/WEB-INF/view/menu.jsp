	...
	<nav class="site-header sticky-top py-1">
		<div class="container d-flex justify-content-between">
			<div class="flex-md-row d-flex">
				<a class="a-color py-2 d-flex flex-md-row" href="/LBEGerenciadorDeProjetoSimples/">
				...
				<a class="a-color py-2 d-none d-md-inline-block" href="/LBEGerenciadorDeProjetoSimples/projeto">Projeto</a>
